...
public class ScannerVC: UIViewController {
    ...
    @objc func photoChangeButtonAction(sender: UIButton) {
...
extension ScannerVC{
    ...
    func setupUI() {
        ...
        headerViewController.photosButton.addTarget(self, action: #selector(photoChangeButtonAction(sender:)), for: .touchUpInside)
